    ...
    <div class="row">
        <div class="col-md-4 col-sm-6 col-xs-12 top-margin">
            ...
            <div class="warp-border">
                <div class="clearfix">
                    <div class="icon-people"><img src="imges/${oc.avatar}.png"></div>
                    <div class="text">
                        <h4 class="">${oc.v_name}</h4>
                        <p class="text-present">${oc.v_introduce}</p>
                    </div>
                </div>

                <div class="warp-class2">
                    <div class="warp-class2-text">
                        <div class="iconfont text-padding">门槛 <img src="imges/.png"></div>
                    </div>
                    <div class="warp-class2-text">
