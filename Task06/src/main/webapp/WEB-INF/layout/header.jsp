        ...
        <ul class="col-lg-6 col-md-6 col-sm-6 col-xs-12 icon-header">
            ...
            <c:choose>
                <c:when test="${user == null}">
                    <li><a href="${pageContext.request.contextPath}/login" style="font-size:15px; color: black;">注册</a></li>
                    <li>|</li>
                    <li><a href="${pageContext.request.contextPath}/login" style="font-size:15px; color: black;">登录</a></li>
                </c:when>
                <c:otherwise>
                    <li><a href="${pageContext.request.contextPath}/logout" style="font-size:15px; color: black;">退出</a></li>
                    <li>|</li>
        ...
        <div class="row">
            ...
            <div id="navbar" class="col-lg-6 col-md-6 col-sm-6 collapse navbar-collapse navbar-right"
                ...
                <ul class="nav navbar-nav navbar-right text-center">
                    <li class="green-border-bottom active"><a href="${pageContext.request.contextPath}/home"><span>首页</span></a></li>
                    <li class="green-border-bottom"><a href="${pageContext.request.contextPath}/u/occupation"><span>职业</span></a></li>
