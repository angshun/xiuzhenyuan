...
//        long zero = cal.toInstant().toEpochMilli()/* - (long) 1000 * 60 * 60 * 24 * 1*/;
    ...
    public static long timeUtil2(long num) {
        /*
        时间处理方法
         */
        Calendar cal = Calendar.getInstance();
    ...
    public static long timeUtil(long num, boolean startTime) {
        /*
        判断考勤时间
         */
        Calendar cal = Calendar.getInstance();
    ...
    public static String formatTime(String string) {
        ...
        String createAt = simpleDateFormat.format(new Date(Long.parseLong(string)));
        return createAt;
    }
