...
<json:object escapeXml="false">
    <json:property name="code" value="${objectsByIds1.code}"></json:property>
    <json:property name="message">
        <spring:message code="${objectsByIds1.code}"/>
    </json:property>
    <json:property name="size" value="${objectsByIds1.size}"></json:property>
    <json:property name="total" value="${objectsByIds1.total}"></json:property>
    <json:property name="page" value="${objectsByIds1.page}"></json:property>
    <json:array name="data">
        <c:forEach items="${objectsByIds1.data}" var="task">
            <json:object>
