...
<%@ include file="../../../includes/includes.jsp"%>
	...
	<div id="moduleDetailApp" ng-app="moduleDetailApp">
		<div ng-controller="moduleDetailController">
			...
			<div class="portlet">
			    ...
			    <form class="form-horizontal" role="form" name="moduleForm">
			        ...
			        <div class="col-sm-6">
			          <input type="text" class="form-control" name="menuId" ng-model="module.menuId" ng-bind="module.menuId" placeholder="请输入菜单id" required>
			        </div>
			        </div>
			        ...
			        <div class="col-sm-6">
			          <input type="text" class="form-control" name="icon" ng-model="module.icon" ng-bind="module.icon" placeholder="请输入图标" required>
			        </div>
			        </div>
			        ...
			        <div class="col-sm-6">
			          <input type="text" class="form-control" name="level" ng-model="module.level" ng-bind="module.level" placeholder="请输入等级" required>
			        </div>
			        </div>
	                ...
	                <div class="form-group">
			        <label for="url" class="col-sm-2 control-label">模块url</label>
			        <div class="col-sm-6">
			          <input type="text" class="form-control" name="url" ng-model="module.url" ng-bind="module.url" placeholder="请输入模块url" required>
			        </div>
			        </div>
	 ...
	 <script src="/r/js-src/web/score-admin-service/module/moduleDetail.js"></script>
