        ...
        <c:forEach items="${entryList}" var="entry">
            <json:array name="">
                <json:object>
                    ...
                    <json:property name="scoreReason" value="${entry.get(1).scoreReason}"></json:property>
                    <json:property name="scoreChange" value="${entry.get(1).scoreChange}"></json:property>
                    ...
                    <json:property name="specialId" value="${entry.get(1).specialId}"></json:property>
                </json:object>
