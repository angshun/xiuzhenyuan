...
<json:object escapeXml="false">
    ...
    <json:object name="data">
        ...
        <json:property name="outsideWorkTime" value="${dailyAttendance.outsideWorkTime}"></json:property>

        <json:property name="outsideWorkTimeScore" value="${dailyAttendance.outsideWorkTimeScore}"></json:property>


        <json:property name="outsideClosingTime" value="${dailyAttendance.outsideClosingTime}"></json:property>

        <json:property name="outsideClosingTimeScore"
                       value="${dailyAttendance.outsideClosingTimeScore}"></json:property>


        <json:property name="logReleaseTime" value="${dailyAttendance.logReleaseTime}"></json:property>

        <%--<json:property name="logNormalScore" value="${dailyAttendance.logNormalScore}"></json:property>--%>
