...
<json:object escapeXml="false">
    ...
    <json:object name="data">
        ...
        <json:property name="positionScore" value="${staff.positionScore}"></json:property>
        ...
        <json:property name="starId" value="${staff.starId}"></json:property>

        <json:property name="degreeId" value="${staff.degreeId}" ></json:property>
        <json:property name="honorId" value="${staff.honorId}" ></json:property>
        <json:property name="jopId" value="${staff.jopId}" ></json:property>
        <json:property name="specialityId" value="${staff.specialityId}" ></json:property>


        <json:property name="starScore" value="${staff.starScore}"></json:property>
