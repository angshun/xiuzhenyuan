        ...
        <c:forEach items="${list}" var="entry">
            <json:array name="">
                ...
                <json:object>
                    ...
                    <json:property name="attendanceType" value="${entry.get(1).attendanceType}"></json:property>

                    <json:property name="attendanceAddress" value="${entry.get(1).attendanceAddress}"></json:property>

                    <json:property name="attendanceStatus" value="${entry.get(1).attendanceStatus}"></json:property>
