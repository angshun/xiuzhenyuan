...
public class ProfessionTagController {
	...
	public String getprofessionTagList(HttpServletRequest request,
		...
		return "/carrots-bangbang-home-service/professionTag/view/professionTagList";
	}
	...
	public String getProfessionTag(HttpServletRequest request,
		...
		return "/carrots-bangbang-home-service/professionTag/view/professionTagDetail";
	}
	...
	@RequestMapping(value = "/a/professionTag/{id}", method = RequestMethod.GET)
	public String getProfessionTagJson(HttpServletRequest request,
		...
		return "/carrots-bangbang-home-service/professionTag/json/professionTagDetailJson";
	}
	...
	public String getMultiProfessionTagJson(HttpServletRequest request,
	   ...
	   if (ids == null) {
		...
		return "/carrots-bangbang-home-service/professionTag/json/professionTagListJson";
	}
