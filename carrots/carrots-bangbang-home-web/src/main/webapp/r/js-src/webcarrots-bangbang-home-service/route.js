...
function projectRouteConfig($stateProvider, $urlRouterProvider, $ocLazyLoadProvider) {
    ...
    $stateProvider
        ...
        .state('field.dashboard', {
           ...
           //教材管理
        .state('field.professionTagList', {
            url: '/professionTagList',
            templateUrl: 'views/professionTagList.html',
            controller: 'ProfessionTagListController',
            controllerAs: 'vm',
            resolve: {
                loadMyFile: _lazyLoad([
                    'js/controllers/professionTag/professionTagListController.js'
                ])
            }
        })
        //教材编辑等管理
        .state('field.professionTagDetails', {
            url: '/professionTagDetails/:id',
            templateUrl: 'views/professionTagDetails.html',
            controller: 'ProfessionTagDetailController',
            controllerAs: 'vm',
            resolve: {
                loadMyFile: _lazyLoad([
                    'js/controllers/professionTag/professionTagDetailsController.js'
                ])
            }
        })      
