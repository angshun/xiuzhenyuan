...
<%@ include file="../../../includes/includes.jsp"%>
	...
	<div id="productDetailApp" ng-app="productDetailApp">
		<div ng-controller="productDetailController">
			...
			<div class="portlet">
			    ...
			    <form class="form-horizontal" role="form" name="productForm">
	                ...
	                <div class="form-group">
			        <label for="summary" class="col-sm-2 control-label">产品简介</label>
			        <div class="col-sm-6">
			          <input type="text" class="form-control" name="summary" ng-model="product.summary" ng-bind="product.summary" placeholder="请输入产品简介" required>
			        </div>
			        </div>
			        ...
			        <div class="col-sm-6">
			          <input type="text" class="form-control" name="cid" ng-model="product.cid" ng-bind="product.cid" placeholder="请输入公司id" required>
			        </div>
			        </div>
	 ...
	 <script src="/r/js-src/web/carrots-bangbang-admin-service/product/productDetail.js"></script>
