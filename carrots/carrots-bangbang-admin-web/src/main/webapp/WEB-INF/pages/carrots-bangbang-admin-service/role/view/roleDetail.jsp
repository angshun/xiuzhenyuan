...
<%@ include file="../../../includes/includes.jsp"%>
	...
	<div id="roleDetailApp" ng-app="roleDetailApp">
		<div ng-controller="roleDetailController">
			...
			<div class="portlet">
			    ...
			    <form class="form-horizontal" role="form" name="roleForm">
			        ...
			        <div class="col-sm-6">
			          <input type="text" class="form-control" name="status" ng-model="role.status" ng-bind="role.status" placeholder="请输入" required>
			        </div>
			        </div>
	                ...
	                <div class="form-group">
			        <label for="permissons" class="col-sm-2 control-label">权限</label>
			        <div class="col-sm-6">
			          <input type="text" class="form-control" name="permissons" ng-model="role.permissons" ng-bind="role.permissons" placeholder="请输入权限" required>
			        </div>
			        </div>
	 ...
	 <script src="/r/js-src/web/carrots-bangbang-admin-service/role/roleDetail.js"></script>
