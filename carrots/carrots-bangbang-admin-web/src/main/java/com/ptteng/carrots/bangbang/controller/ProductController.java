...
public class ProductController {
	...
	public String getproductList(HttpServletRequest request,
		...
		return "/carrots-bangbang-admin-service/product/view/productList";
	}
	...
	public String getProduct(HttpServletRequest request,
		...
		return "/carrots-bangbang-admin-service/product/view/productDetail";
	}
	...
	public String getProductJson(HttpServletRequest request,
		...
		return "/carrots-bangbang-admin-service/product/json/productDetailJson";
	}
	...
	public String getMultiProductJson(HttpServletRequest request,
	   ...
	   if (ids == null) {
		...
		return "/carrots-bangbang-admin-service/product/json/productListJson";
	}
