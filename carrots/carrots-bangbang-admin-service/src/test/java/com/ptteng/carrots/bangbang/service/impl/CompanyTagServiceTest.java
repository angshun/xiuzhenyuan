...
public class CompanyTagServiceTest {
	...
	@Before
	    public void setUp() throws Exception{
			...
			//local server
			/**
			companyTagService = (CompanyTagService)  Naming.lookup("//localhost:20027/CompanyTagRMIService");
			**/
