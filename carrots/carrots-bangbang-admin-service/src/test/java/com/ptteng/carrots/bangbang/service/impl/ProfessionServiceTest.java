...
public class ProfessionServiceTest {
	...
	@Before
	    public void setUp() throws Exception{
			...
			//local server
			/**
			professionService = (ProfessionService)  Naming.lookup("//localhost:20027/ProfessionRMIService");
			**/
